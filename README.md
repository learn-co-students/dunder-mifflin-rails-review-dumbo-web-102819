...
#Dog and employee share a one to many relationship (a dog has many owners (employees), and an employee belongs to a dog)
...
#Controller methods for Dog: index, show
@Controller methods for Employee: index, show, and create
